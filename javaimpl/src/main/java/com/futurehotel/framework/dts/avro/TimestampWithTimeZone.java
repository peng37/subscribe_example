...
public class TimestampWithTimeZone extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public DateTimeT value;
   ...
   */
  public TimestampWithTimeZone(DateTimeT value, java.lang.String timezone) {
    this.value = value;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: value = (DateTimeT)value$; break;
   ...
   */
  public void setValue(DateTimeT value) {
    this.value = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TimestampWithTimeZone>
    ...
    private DateTimeT value;
    private DateTimeT.Builder valueBuilder;
    ...
    private Builder(TimestampWithTimeZone.Builder other) {
      ...
      if (other.hasValueBuilder()) {
        this.valueBuilder = DateTimeT.newBuilder(other.getValueBuilder());
      }
    ...
    /**
      ...
      * @return This builder.
      */
    public TimestampWithTimeZone.Builder setValue(DateTimeT value) {
     ...
     * @return This builder.
     */
    public DateTimeT.Builder getValueBuilder() {
      if (valueBuilder == null) {
        if (hasValue()) {
          setValueBuilder(DateTimeT.newBuilder(value));
        } else {
          setValueBuilder(DateTimeT.newBuilder());
        }
      }
      return valueBuilder;
    }
     ...
     * @return This builder.
     */
    public TimestampWithTimeZone.Builder setValueBuilder(DateTimeT.Builder value) {
      clearValue();
      valueBuilder = value;
      return this;
    }
    ...
    public TimestampWithTimeZone build() {
      try {
        ...
        if (valueBuilder != null) {
          ...
          record.value = fieldSetFlags()[0] ? this.value : (DateTimeT) defaultValue(fields()[0]);
        }
