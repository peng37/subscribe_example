...
public class DateTimeT extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<DateTimeT> ENCODER =
      new BinaryMessageEncoder<DateTimeT>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<DateTimeT> DECODER =
      new BinaryMessageDecoder<DateTimeT>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<DateTimeT> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<DateTimeT> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<DateTimeT>(MODEL$, SCHEMA$, resolver);
  }
  ...
  public static DateTimeT fromByteBuffer(
   ...
   */
  public DateTimeT(java.lang.Integer year, java.lang.Integer month, java.lang.Integer day, java.lang.Integer hour, java.lang.Integer minute, java.lang.Integer second, java.lang.Integer millis) {
    this.year = year;
    this.month = month;
    this.day = day;
    this.hour = hour;
   ...
   */
  public static DateTimeT.Builder newBuilder() {
    return new DateTimeT.Builder();
  }
   ...
   * @return A new DateTime RecordBuilder
   */
  public static DateTimeT.Builder newBuilder(DateTimeT.Builder other) {
    return new DateTimeT.Builder(other);
  }
   ...
   * @return A new DateTime RecordBuilder
   */
  public static DateTimeT.Builder newBuilder(DateTimeT other) {
    return new DateTimeT.Builder(other);
  }
   ...
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DateTimeT>
    implements org.apache.avro.data.RecordBuilder<DateTimeT> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(DateTimeT.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(DateTimeT other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.year)) {
        this.year = data().deepCopy(fields()[0].schema(), other.year);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public DateTimeT.Builder setYear(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public DateTimeT.Builder clearYear() {
      year = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public DateTimeT.Builder setMonth(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public DateTimeT.Builder clearMonth() {
      month = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public DateTimeT.Builder setDay(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public DateTimeT.Builder clearDay() {
      day = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public DateTimeT.Builder setHour(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public DateTimeT.Builder clearHour() {
      hour = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public DateTimeT.Builder setMinute(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public DateTimeT.Builder clearMinute() {
      minute = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public DateTimeT.Builder setSecond(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public DateTimeT.Builder clearSecond() {
      second = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public DateTimeT.Builder setMillis(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public DateTimeT.Builder clearMillis() {
      millis = null;
    ...
    public DateTimeT build() {
      try {
        DateTimeT record = new DateTimeT();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<DateTimeT>
    WRITER$ = (org.apache.avro.io.DatumWriter<DateTimeT>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<DateTimeT>
    READER$ = (org.apache.avro.io.DatumReader<DateTimeT>)MODEL$.createDatumReader(SCHEMA$);
