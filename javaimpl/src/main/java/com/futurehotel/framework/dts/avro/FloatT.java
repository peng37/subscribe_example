...
public class FloatT extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<FloatT> ENCODER =
      new BinaryMessageEncoder<FloatT>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<FloatT> DECODER =
      new BinaryMessageDecoder<FloatT>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<FloatT> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<FloatT> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<FloatT>(MODEL$, SCHEMA$, resolver);
  }
  ...
  public static FloatT fromByteBuffer(
   ...
   */
  public FloatT(java.lang.Double value, java.lang.Integer precision, java.lang.Integer scale) {
    this.value = value;
   ...
   */
  public static FloatT.Builder newBuilder() {
    return new FloatT.Builder();
  }
   ...
   * @return A new Float RecordBuilder
   */
  public static FloatT.Builder newBuilder(FloatT.Builder other) {
    return new FloatT.Builder(other);
  }
   ...
   * @return A new Float RecordBuilder
   */
  public static FloatT.Builder newBuilder(FloatT other) {
    return new FloatT.Builder(other);
  }
   ...
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FloatT>
    implements org.apache.avro.data.RecordBuilder<FloatT> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(FloatT.Builder other) {
      super(other);
    ...
    /**
      ...
      * @return This builder.
      */
    public FloatT.Builder setValue(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public FloatT.Builder clearValue() {
    ...
    /**
      ...
      * @return This builder.
      */
    public FloatT.Builder setPrecision(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public FloatT.Builder clearPrecision() {
    ...
    /**
      ...
      * @return This builder.
      */
    public FloatT.Builder setScale(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public FloatT.Builder clearScale() {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<FloatT>
    WRITER$ = (org.apache.avro.io.DatumWriter<FloatT>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<FloatT>
    READER$ = (org.apache.avro.io.DatumReader<FloatT>)MODEL$.createDatumReader(SCHEMA$);
