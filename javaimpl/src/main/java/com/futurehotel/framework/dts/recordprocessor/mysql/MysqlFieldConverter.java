package com.futurehotel.framework.dts.recordprocessor.mysql;

import com.futurehotel.framework.dts.avro.BinaryGeometry;
import com.futurehotel.framework.dts.avro.BinaryObject;
import com.futurehotel.framework.dts.avro.CharacterT;
import com.futurehotel.framework.dts.avro.DateTimeT;
import com.futurehotel.framework.dts.avro.DecimalT;
import com.futurehotel.framework.dts.avro.Field;
import com.futurehotel.framework.dts.avro.FloatT;
import com.futurehotel.framework.dts.avro.IntegerT;
import com.futurehotel.framework.dts.avro.TextObject;
import com.futurehotel.framework.dts.avro.Timestamp;
import com.futurehotel.framework.dts.recordprocessor.FieldConverter;
import com.futurehotel.framework.dts.recordprocessor.FieldValue;
...
public class MysqlFieldConverter implements FieldConverter {
    ...
    static class NumberStringAdapter implements DataAdapter {
        public FieldValue getFieldValue(Object data) {
            FieldValue fieldValue = new FieldValue();
            if (null != data) {
                IntegerT integer = (IntegerT) data;
    ...
    static class DecimalStringAdapter implements DataAdapter {
        public FieldValue getFieldValue(Object data) {
            FieldValue fieldValue = new FieldValue();
            if (null != data) {
                DecimalT decimal = (DecimalT) data;
    ...
    static abstract class AbstractDateTimeAdapter implements DataAdapter {
        ...
        void encodeDate(DateTimeT dateTime, byte[] out, int position) {
        ...
        void encodeTime(DateTimeT dateTime, byte[] out, int position) {
            if (null != dateTime && null != out) {
        ...
        void encodeTimeMillis(DateTimeT dateTime, byte[] out, int position) {
    ...
    static class DateAdapter extends AbstractDateTimeAdapter {
        ...
        public FieldValue getFieldValue(Object data) {
            ...
            FieldValue fieldValue = new FieldValue();
            if (null != data) {
                DateTimeT dateTime = (DateTimeT) data;
    ...
    static class CharacterAdapter implements DataAdapter  {
        ...
        public FieldValue getFieldValue(Object data) {
            ...
            FieldValue fieldValue = new FieldValue();
            if (null != data) {
                CharacterT character = (CharacterT) data;
